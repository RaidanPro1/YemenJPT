    ...
    <div className="space-y-10 animate-in fade-in duration-500 pb-20 text-right" dir="rtl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
        ...
        <div className="lg:col-span-3 space-y-8">
           ...
           {showResults && (
             <div className="glass-morphism p-12 rounded-[4rem] border border-emerald-500/30 space-y-12 shadow-3xl animate-in zoom-in-95">
                <div className="flex flex-row-reverse justify-between items-center border-b border-slate-800 pb-10">
                   <div className="text-right">
                      ...
                      <p className="text-emerald-400 font-bold text-md mt-4 flex items-center justify-end gap-3">
                   ...
                   <div className="p-8 bg-slate-950/40 rounded-[2.5rem] border border-slate-800 space-y-6">
                      ...
                      <div className="space-y-4">
                         <div className="flex justify-between items-center">
                            ...
                            <span className="text-slate-400 text-xs font-bold">تطابق الميتا داتا</span>
                         </div>
                         <div className="h-2 bg-slate-900 rounded-full overflow-hidden"><div className="h-full bg-emerald-500 w-[100%]"></div></div>
                      </div>
                   </div>
                   <div className="p-8 bg-slate-950/40 rounded-[2.5rem] border border-slate-800 space-y-6">
